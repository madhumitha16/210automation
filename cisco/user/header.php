  ...
  <body class="sidebar-collapsible sidebar-open">
    <div class="st-wrapper">
      <div class="st-sidebar">
        <div class="st-sidebar__header"><a class="st-sidebar__logo" href="">Cisco User</a>
            ...
            <div class="st-sidebar__nav">
              <ul>
				...
				<li><a href="fileupload.php">
                    <div class="fluid-cols">
                      <div class="min-col"><i class="fa fa-star st-sidebar__ico"></i></div>
                      <div class="expand-col text-ellipsis"><span class="st-sidebar__title">File Upload</span></div>
                    </div></a></li>
              </ul>
            </div>
          </div>
	  ...
	  <div class="st-header">
          <div class="fluid-cols">
            ...
            <div class="expand-col text-ellipsis">
              <div class="st-header__title"><span>Welcome, <?php echo $_SESSION['username']; ?></span>
              </div>
            </div>
            <div class="min-col">
