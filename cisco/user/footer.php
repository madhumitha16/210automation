<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <script src="libs/datatables/js/dataTables.bootstrap.js"></script><!-- Page App Modules -->
    <script src="js/modules/service/api.js"></script>
    <script src="js/modules/service/data-mapper.js"></script>
    <script src="js/modules/widgets/am-chart.js"></script>
    <script src="js/modules/widgets/table.js"></script>
    <script src="js/modules/widgets/detailed-chart.js"></script>
    <script src="js/modules/widgets/afeed.js"></script>
    <script src="js/modules/pages/overview.js"></script><!-- Analytics and visitor tracking scripts can be placed here -->
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter44536084 = new Ya.Metrika({
                    id:44536084,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/44536084?ut=noindex" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->

  </body>

<!-- Mirrored from demo.adminbootstrap.com/just/1.0.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2017 06:08:07 GMT -->
</html>